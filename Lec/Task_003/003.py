...
# a = int(input("Ученики класса 1: "))
# b = int(input("Ученики класса 2: "))
# c = int(input("Ученики класса 3: "))

a = 20
b = 21
c = 22

klassOne = bool(a % 2) + (a // 2)
klassTwo = bool(b % 2) + (b // 2)
klassTree = bool(c % 2) + (c // 2)

allTables = klassOne + klassTwo + klassTree
